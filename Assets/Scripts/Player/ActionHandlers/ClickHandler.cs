...
namespace Player.ActionHandlers
{
    public class ClickHandler : DontDestroyMonoBehaviourSingleton<ClickHandler>
    {
        ...
        public event Action<Vector2> ScreenDragStartEvent;
        public event Action<Vector2> ScreenDragEndEvent;
        public event Action<Vector2> ScreenDragEvent;
        ...
        private void Update()
        {
            ...
            else if (Input.GetMouseButtonUp(0))
            {
                ...
                if (_isDrag)
                {
                    ...
                    ScreenDragEndEvent?.Invoke(Input.mousePosition);
            ...
            {
                ScreenDragEvent?.Invoke(Input.mousePosition);
            }
        }
        ...
        private void LateUpdate()
        {
            ...
            if (_clickHoldDuration >= clickToDragDuration)
            {
                ...
                ScreenDragStartEvent?.Invoke(Input.mousePosition);
